...
```sh
expo install react-native-ble-manager @vainoristimaki/react-native-ble-manager-plugin
```
...
{
  "expo": {
    "plugins": ["@vainoristimaki/react-native-ble-manager-plugin"]
  }
}
```
...
```json
{
  "expo": {
    "plugins": [
      [
        "@vainoristimaki/react-native-ble-manager-plugin",
        {
